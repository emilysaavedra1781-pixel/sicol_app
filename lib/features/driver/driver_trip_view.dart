        ...
        content: Column(
          ...
          children: [
            ...
            if (!todosBajaron) ...[
              ...
              const Text('⚠️ Hay pasajeros que aún no han llegado a su destino. ¿Deseas cerrar el viaje de todas formas?',
      ...
      builder: (context, snapshot) {
        ...
        if (enCamino) {
          _tripService.todosBajaron(widget.viajeId).then((valor) {
            if (mounted && _todosBajaron != valor) setState(() => _todosBajaron = valor);
          });
        }
